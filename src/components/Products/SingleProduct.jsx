    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 justify-center lg:grid-cols-4 lg:gap-4">
        {filteredProducts.map((singleData) => (
          <div
            key={singleData._id}
            className="card mb-8 mt-4 w-[330px] bg-base-100 shadow-xl"
          >
            <figure>
            ...
            <div className="card-body">
              ...
              <Link to={`/details/${singleData._id}`}>
                <button className="btn btn-outline btn-wide btn-secondary">
                  Details
                </button>
              </Link>

              <Link to="/update">
                <button className="btn btn-outline btn-wide btn-accent">
                  Update
                </button>
              </Link>
