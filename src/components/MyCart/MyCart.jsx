...
const MyCart = () => {
        ...
        fetch(`https://assingment-10.vercel.app/cart/${_id}`, {
          ...
          .then((data) => {
            ...
            if(data.deletedCount>0){
              ...
              const remaining = cartProduct.filter(cartt=>cartt._id !== _id)
  ...
  return (
    <div className="grid lg:grid-cols-2 lg:ml-14">
     {
        cartData.map(cart=> <div key={cart._id} className="card my-10 lg:w-[600px] lg:h-[320px] h-[350px] card-side bg-base-100 shadow-xl">
        <figure>
