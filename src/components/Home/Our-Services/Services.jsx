      ...
      <div className="text-center lg:gap-4 lg:mr-10 lg:ml-14 lg:mt-12 mt-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
        <div className="card card-compact mr-2 mb-2 py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              Google is a technology company that specializes in
        ...
        <div className="card card-compact py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              Samsung offers a wide range of products and services, including
              smartphones, TVs, appliances, online services, and
        ...
        <div className="card card-compact py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              Apple is an American technology company that specializes in
        ...
        <div className="card card-compact py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              OnePlus Care: A customer support service that provides users with
              help with their OnePlus devices.
            </p>
          </div>
        </div>
        <div className="card card-compact py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              Xiaomi is a Chinese electronics company that specializes in
              smartphones, wearable devices, and other consumer electronics.
            </p>
          </div>
        </div>
        <div className="card card-compact py-4 bg-base-100 shadow-xl">
          ...
          <div className="p-4">
            ...
            <p>
              Nokia is a Finnish telecommunications company that specializes in
              mobile phone networks, network infrastructure, and software.
            </p>
          </div>
        </div>
      </div>
